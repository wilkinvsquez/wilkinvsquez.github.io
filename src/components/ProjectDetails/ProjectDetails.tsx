	...
	return (
		<div className='project-details section'>
			<div className='container'>
				<button
					onClick={() => navigate(-1)}
					className='btn project-details__back'>
					<ArrowLeft size={20} />
					{t.common.back}
				</button>
				...
				<div
					className={`project-details__content ${!project.images || project.images.length === 0 ? "no-images" : ""}`}>
					...
					<div className='project-details__info'>
						<h2 className='project-details__subtitle'>
